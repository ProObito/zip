...
from config import ADMIN_IDS, SUPPORT_CHAT
...
def register_handlers(app: Client):
    ...
    @app.on_message(filters.private & filters.command("addautho_user") & filters.user(ADMIN_IDS))
    ...
    @app.on_message(filters.private & filters.command("delautho_user") & filters.user(ADMIN_IDS))
    ...
    @app.on_message(filters.private & filters.command("autho_users") & filters.user(ADMIN_IDS))
